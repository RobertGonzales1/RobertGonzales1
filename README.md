...
Systems Administrator with a B.S. in Computer Information Systems and a growing stack of certifications to back it up. I build, break, and fix things in my HomeLab so I can do it better at work. Whether it's virtualization, Docker, networking, or monitoring — I like getting my hands on it.

If you're a recruiter, you'll find my certs and skills below. If you're a coworker, check out my HomeLab. If you're family — yes, this is what I do for fun.

---

## 🧰 What I Work With

**Virtualization & Containers:** Proxmox, VMware, Docker

**Networking:** TCP/IP, DNS, DHCP, VPN, Firewalls

**Cloud & Monitoring:** Azure, New Relic

**OS:** Windows Server, Linux (Ubuntu, CentOS)

**Tools & Practices:** Git, PowerShell, Bash
...
**CompTIA**
- 🔗 [A+](https://www.credly.com/badges/18a82104-08e8-4767-8d30-faf2c577a869/)
...
- 🔗 [Certified APM Practitioner Associate (APA)](https://credentials.newrelic.com/ac6b6efa-bbc4-40d5-b7a2-2b0e57fde90a#acc.TgmHxVkG)
...
This is where the real learning happens. I maintain a personal HomeLab to experiment with infrastructure, networking, containerization, and self-hosted services. Think of it as my IT playground.
...
- Building out more Docker and Infrastructure as Code projects
- Contributing to open-source IT and sysadmin tools
